...
const PolicyPage = () => {
    ...
    const defaultCookiesPolicy = `
        <h2>Cookie Policy for Inkcore</h2>
        <p>At Inkcore, we believe in being clear and open about how we collect and use data related to you. In the spirit of transparency, this policy provides detailed information about how and when we use cookies on our Website.</p>
        
        <h3>What is a cookie?</h3>
        <p>A cookie is a small file placed onto your device that enables Inkcore features and functionality. For example, cookies enable us to identify your device, secure your access to our site, and even help us know if someone attempts to access your account from a different device.</p>
            ...
            try {
                ...
                if (res.data && res.data[type]) {
                    ...
                    setPolicy({
                        ...
                        meta_description: 'Information about how Inkcore uses cookies on its website.'
                    });
                } else {
                    setPolicy(null);
                }
